...
///
// USAGE:
// First initialize the plugin: Vibration.Init();
// iOS (6s and up) and Android vibrations:
// - Vibration.Vibrate(); - Default 400ms vibration
// - Vibration.VibratePop(); - Short vibration
// - Vibration.VibratePeek(); - Long vibration
// - Vibration.VibrateNope(); - 3 times vibration
// Android only:
// - Vibration.Vibrate(500); - Custom duration in milliseconds
// - long [] pattern = { 0, 1000, 1000, 1000, 1000 }; Vibration.Vibrate ( pattern, -1 ); - Pattern vibration
// - Vibration.Cancel(); - Cancel current vibration
//Source: Authors GitHub page
